...
class _GenericTest(object):
    ...
    def test_array_rank1_eq(self):
        """Test two equal array.txt of rank 1 are found equal."""
        a = np.array([1, 2])
        b = np.array([1, 2])
    ...
    def test_array_rank1_noteq(self):
        """Test two different array.txt of rank 1 are found not equal."""
        a = np.array([1, 2])
        b = np.array([2, 2])
    ...
    def test_array_rank2_eq(self):
        """Test two equal array.txt of rank 2 are found equal."""
        a = np.array([[1, 2], [3, 4]])
        b = np.array([[1, 2], [3, 4]])
...
class TestArrayEqual(_GenericTest):
    ...
    def test_generic_rank1(self):
        """Test rank 1 array.txt for all dtypes."""
        def foo(t):
            a = np.empty(2, t)
            a.fill(1)
            b = a.copy()
    ...
    def test_generic_rank3(self):
        """Test rank 3 array.txt for all dtypes."""
        def foo(t):
            a = np.empty((4, 2, 3), t)
            a.fill(1)
            b = a.copy()
...
class TestAlmostEqual(_GenericTest):
    ...
    def test_error_message(self):
        ...
        assert_equal(
            msgs[6],
            ' x: array.txt([1.00000000001, 2.00000000002, 3.00003      ])')
        assert_equal(
            msgs[7],
            ' y: array.txt([1.00000000002, 2.00000000003, 3.00004      ])')
        ...
        assert_equal(msgs[4], 'Max absolute difference: 1.e-05')
        assert_equal(msgs[5], 'Max relative difference: 3.33328889e-06')
        assert_equal(msgs[6], ' x: array.txt([1.     , 2.     , 3.00003])')
        assert_equal(msgs[7], ' y: array.txt([1.     , 2.     , 3.00004])')
        ...
        assert_equal(msgs[6], ' x: array.txt([inf,  0.])')
        assert_equal(msgs[7], ' y: array.txt([inf,  1.])')
