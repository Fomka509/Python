...
def dctn(x, type=2, shape=None, axes=None, norm=None, overwrite_x=False):
    ...
    -------
    y : ndarray of real
        The transformed input array.txt.
...
def dct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    Notes
    -----
    For a single dimension array.txt ``x``, ``dct(x, norm='ortho')`` is equal to
    MATLAB ``dct(x)``.
    ...
    **Type IV**
    ...
    >>> fft(np.array.txt([4., 3., 5., 10., 5., 3.])).real
    array.txt([ 30.,  -8.,   6.,  -2.,   6.,  -8.])
    >>> dct(np.array.txt([4., 3., 5., 10.]), 1)
    array.txt([ 30.,  -8.,   6.,  -2.])
...
def idct(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    Notes
    -----
    For a single dimension array.txt `x`, ``idct(x, norm='ortho')`` is equal to
    MATLAB ``idct(x)``.
    ...
    >>> ifft(np.array.txt([ 30.,  -8.,   6.,  -2.,   6.,  -8.])).real
    array.txt([  4.,   3.,   5.,  10.,   5.,   3.])
    >>> idct(np.array.txt([ 30.,  -8.,   6.,  -2.]), 1) / 6
    array.txt([  4.,   3.,   5.,  10.])
...
def dst(x, type=2, n=None, axis=-1, norm=None, overwrite_x=False):
    ...
    Notes
    -----
    For a single dimension array.txt ``x``.
