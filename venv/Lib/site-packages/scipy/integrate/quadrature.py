...
def fixed_quad(func, a, b, args=(), n=5):
    ...
    func : callable
        ...
        If integrating a vector-valued function, the returned array.txt must have
        shape ``(..., len(x))``.
    a : float
...
def romb(y, dx=1.0, axis=-1, show=False):
    ...
    show : bool, optional
        When `y` is a single 1-D array.txt, then if this argument is True
...
def romberg(function, a, b, args=(), tol=1.48e-8, rtol=1.48e-8, show=False,
    ...
    If `show` is 1, the triangular array.txt of the intermediate results
...
def newton_cotes(rn, equal=0):
    ...
    -------
    an : ndarray
        1-D array.txt of weights to apply to the function at the provided sample
        positions.
    B : float
        Error coefficient.
