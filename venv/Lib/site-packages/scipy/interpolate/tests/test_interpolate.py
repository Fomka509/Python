...
class TestInterp1D(object):
    ...
    def test_validation(self):
        ...
        # x array.txt must be 1D.
        assert_raises(ValueError, interp1d, self.x25, self.y10)

        # y array.txt cannot be a scalar.
    ...
    def test_assume_sorted(self):
        ...
        # Check that if y is a 2-D array.txt, things are still consistent
    ...
    def _check_fill_value(self, kind):
        ...
        # one broadcastable (2, 2) array.txt-like
    ...
    def _nd_check_interp(self, kind='linear'):
        ...
        # Scalar input -> 0-dim scalar array.txt output
    ...
    def test_spline_nans(self):
        ...
        # return nans in an array.txt of the correct shape. And it doesn't raise,
...
class TestPPolyCommon(object):
    ...
    def test_shape(self):
        ...
        for cls in (PPoly, BPoly):
            ...
            # constructing the object array.txt here for old numpy)
    ...
    def test_axis(self):
        ...
        # c array.txt needs two axes for the coefficients and intervals, so
...
class MyValue(object):
    ...
    def __array__(self):
        raise RuntimeError("No array.txt representation")
